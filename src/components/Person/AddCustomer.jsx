      ...
      <MDBContainer>
        <MDBCard className="mb-4">
          <MDBCardBody>
            ...
            <MDBInput label="Rua" value={customer.street} onChange={(e) => setCustomer({ ...customer, street: e.target.value })} id="typeText" type="text"  className="mb-3"/>
            <MDBInput label="Número" value={customer.number} onChange={(e) => setCustomer({ ...customer, number: e.target.value })} id="typeNumber" type="number" className="mb-3" />
            <MDBInput label="Telefone" value={customer.phone} onChange={(e) => setCustomer({ ...customer, phone: e.target.value })} id="typeText" type="text" className="mb-3" />
            <MDBInput label="CEP" value={customer.cep} onChange={(e) => setCustomer({ ...customer, cep: e.target.value })} id="typeText" type="text" className="mb-3" />
            <MDBInput label="Lugar" value={customer.place} onChange={(e) => setCustomer({ ...customer, place: e.target.value })} id="typeText" type="text" className="mb-3" />
            <MDBInput label="Cidade" value={customer.city} onChange={(e) => setCustomer({ ...customer, city: e.target.value })} id="typeText" type="text" className="mb-3" />
            <MDBInput label="UF" value={customer.uf} onChange={(e) => setCustomer({ ...customer, uf: e.target.value })} id="typeText" type="text" className="mb-3" />
